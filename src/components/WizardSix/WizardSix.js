...
import {updateCost, updateDownPay} from '../../ducks/reducer';

class WizardSix extends Component {

    render(){
        const {updateCost, updateDownPay} = this.props;
        return(
            <div className="parent-div">
                    ...
                    <p>How much are you putting down as a down payment?</p> <br />
                        ...
                        <input type="text" placeholder="amount" onChange={e=> updateDownPay(e.target.value)}/>                    
...
export default connect(mapStateToProps, {updateCost, updateDownPay})(WizardSix);